        ...
        <div className="tech-col">
          ...
          <div className="tech-icons-cover">
            ...
            <img className="icon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg" alt="MongoDB"/>
              <div className="hvrbox-text">MongoDB</div>
              </div>
            </div>
            <div className="tech-icons">
              <div className="hvrbox">
              <img className="icon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" alt="MySQL"/>
              <div className="hvrbox-text">MySQL</div>
              </div>
            ...
            <div className="hvrbox">
            <img className="icon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/npm/npm-original-wordmark.svg" alt="npm"/>
              <div className="hvrbox-text">NPM</div>
              </div>
            ...
            <div className="hvrbox">
            <img className="icon" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/slack/slack-original.svg" alt="Slack"/>
            <div className="hvrbox-text">Slack</div>
              </div>
            <div className="hvrbox">
            ...
            <div className="hvrbox-text">Yarn</div>
            </div>
            </div>
          </div>
        </div>
