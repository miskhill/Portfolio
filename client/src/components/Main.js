import React from 'react'
  ...
  const Main = () => (
    ...
    <img src="https://i.imgur.com/KfjsEHn.jpg" alt="Cav" className="photo"></img>
    <img src="https://i.imgur.com/DfwTRB8.jpg" alt="Cav" className="photo"></img>
    <img src="https://i.imgur.com/GKttS6r.jpg" alt="Cav" className="photo"></img>
    </div>
      </div>
      <div className="card">
      <h2 className="abouth2">
